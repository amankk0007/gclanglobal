...
// Email endpoint that forwards to PHP
app.post('/send-email-proxy.php', async (req, res) => {
    try {
...
// Start server
app.listen(PORT, () => {
    console.log(`🚀 Email test server running at http://localhost:${PORT}`);
    console.log(`📧 Test email functionality at: http://localhost:${PORT}/test-email.html`);
    console.log(`🎯 Career form at: http://localhost:${PORT}/public/career-form-2-saas.html`);
});
