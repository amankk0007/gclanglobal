...
const SvietPage = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        // Course Information
        selectedCourse: "",
        selectedSchool: "Swami Vivekanand Institute of Engineering & Technology",
        programType: "",
    ...
    useEffect(() => {
        ...
        if (paymentStatus === 'success') {
            ...
            // Clean up URL
            window.history.replaceState({}, '', '/apply/sviet');
        }
    }, [searchParams, toast]);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const applicationData = {
                ...
                subject: "New Application Submission - SVIET Banur",
            ...
            await Promise.all([
                ...
                dataService.saveContactForm({
                    ...
                    subject: applicationData.subject || "New Application Submission - SVIET Banur",
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all duration-300"
                            ...
                            <div className="mt-6">
                                <label className="flex items-start gap-3 text-sm text-slate-700">
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        required
                                        className="mt-1 w-4 h-4 text-green-600 border-slate-300 rounded focus:ring-2 focus:ring-green-200"
                                    />
                                    <span className="ml-2">
                            ...
                            <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-200">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="font-bold text-2xl text-green-600">₹25,000</span>
                                    </div>
                                </div>
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-200 max-w-2xl mx-auto">
                            ...
                            <div className="space-y-3">
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-medium text-slate-900">SVIET2026{Math.floor(Math.random() * 10000)}</span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-slate-600">Name:</span>
                                    <span className="font-medium text-slate-900">{formData.firstName} {formData.lastName}</span>
                            ...
                            <div className="flex gap-4">
                                <Button
                                    ...
                                    className="flex-1 bg-gradient-to-r from-green-500 via-green-600 to-green-700 hover:from-green-600 hover:via-green-700 hover:to-green-800 text-white shadow-2xl hover:shadow-green-500/25 px-6 py-3 text-lg font-bold rounded-full transition-all duration-300"
                                >
                                    <FileText className="w-5 h-5 mr-2" />
                                    Print Application
                                </Button>
                                <Button
                                    onClick={() => window.location.href = '/apply/sviet'}
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-slate-50">
            ...
            <main>
                {/* Hero Section */}
                <section className="relative py-20 lg:py-32 overflow-hidden bg-gradient-to-br from-slate-900 via-green-900 to-slate-900">
                    <div className="absolute inset-0">
                        <div className="absolute top-20 left-20 w-96 h-96 bg-gradient-to-r from-green-400 to-green-600 rounded-full blur-3xl opacity-30"></div>
                        <div className="absolute top-40 right-20 w-80 h-80 bg-gradient-to-r from-green-500 to-green-700 rounded-full blur-3xl opacity-30"></div>
                        <div className="absolute bottom-20 left-1/2 w-72 h-72 bg-gradient-to-r from-green-400 to-green-600 rounded-full blur-3xl opacity-30"></div>
                    </div>
                    ...
                    <div className="relative z-10 container mx-auto px-4 text-center">
                        <div className="max-w-4xl mx-auto">
                            ...
                            <h1 className="font-display font-bold text-4xl md:text-6xl lg:text-7xl text-white mb-6 leading-tight">
                                Apply to <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-green-300">
                        ...
                        <div className="max-w-4xl mx-auto">
                            <div className="text-center mb-12">
                                <h2 className="font-display font-bold text-3xl md:text-4xl text-slate-900 mb-6 leading-tight">
                                    Application <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-500 via-green-600 to-green-700">Progress</span>
                                </h2>
      ...
      <div key={step.id} className="relative">
        <div
          className={`flex flex-col md:flex-row items-center text-center p-4 md:p-3 rounded-xl border-2 transition-all duration-300 ${
            currentStep === step.id
              ? "bg-gradient-to-r from-green-500 via-green-600 to-green-700 text-white border-green-600 shadow-lg"
              : currentStep > step.id
                            ...
                            <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-8">
                                ...
                                <div className="hidden sm:flex gap-2">
                                    {Array.from({ length: currentStep - 1 }, (_, index) => (
                                        <div key={index} className="w-2 h-2 bg-green-200 rounded-full"></div>
                                    ))}
                                    <div className={`w-2 h-2 bg-green-600 rounded-full transition-all duration-300 ${
