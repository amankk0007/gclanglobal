                            ...
                            <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-200">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        <label className="block text-sm font-medium text-slate-700">Enter Amount (INR)</label>
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-8 pr-4 py-3 border border-slate-300 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-300"
                        ...
                        <div className="max-w-4xl mx-auto">
                            ...
                            <h1 className="font-display font-bold text-4xl md:text-6xl lg:text-7xl text-white mb-6 leading-tight">
                                Apply to <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-300">
                                    Lamrin Tech Skills University <span className="text-blue-300">Punjab</span>
                                </span>
                            </h1>       
