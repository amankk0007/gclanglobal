...
const RootPage = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        // Course Information
        selectedCourse: "",
        selectedSchool: "Root Country School",
        programType: "",
    ...
    useEffect(() => {
        ...
        if (paymentStatus === 'success') {
            ...
            // Clean up URL
            window.history.replaceState({}, '', '/apply/root');
        }
    }, [searchParams, toast]);

    const courses = [
        {
            school: "Root Country School",
            programs: [
                "Nursery",
                "KG-1 (Kindergarten 1)",
                "KG-2 (Kindergarten 2)",
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const applicationData = {
                ...
                subject: "New Application Submission - Root Country School",
            ...
            await Promise.all([
                ...
                dataService.saveContactForm({
                    ...
                    subject: applicationData.subject || "New Application Submission - Root Country School",
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition-all duration-300"
                        ...
                        <div className="bg-orange-50 rounded-2xl p-8 border border-orange-200">
                            ...
                            <div className="mt-6">
                                <label className="flex items-start gap-3 text-sm text-slate-700">
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        required
                                        className="mt-1 w-4 h-4 text-orange-600 border-slate-300 rounded focus:ring-2 focus:ring-orange-200"
                                    />
                                    <span className="ml-2">
                            ...
                            <div className="flex justify-between">
                                ...
                                <Button
                                    ...
                                    className="bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 hover:from-orange-600 hover:via-orange-700 hover:to-orange-800 text-white shadow-2xl hover:shadow-orange-500/25 px-8 py-4 text-lg font-bold rounded-full transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {isSubmitting ? (
                                        <>
                            ...
                            <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-200">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex justify-between items-center">
                                        ...
                                        <span className="font-bold text-2xl text-orange-600">₹25,000</span>
                                    </div>
                                </div>
                        ...
                        <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-200 max-w-2xl mx-auto">
                            ...
                            <div className="space-y-3">
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-medium text-slate-900">ROOT2026{Math.floor(Math.random() * 10000)}</span>
                                </div>
                                <div className="flex justify-between">
                                    <span className="text-slate-600">Name:</span>
                                    <span className="font-medium text-slate-900">{formData.firstName} {formData.lastName}</span>
                            ...
                            <div className="flex gap-4">
                                <Button
                                    ...
                                    className="flex-1 bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 hover:from-orange-600 hover:via-orange-700 hover:to-orange-800 text-white shadow-2xl hover:shadow-orange-500/25 px-6 py-3 text-lg font-bold rounded-full transition-all duration-300"
                                >
                                    <FileText className="w-5 h-5 mr-2" />
                                    Print Application
                                </Button>
                                <Button
                                    onClick={() => window.location.href = '/apply/root'}
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-slate-50">
            ...
            <main>
                {/* Hero Section */}
                <section className="relative py-20 lg:py-32 overflow-hidden bg-gradient-to-br from-slate-900 via-orange-900 to-slate-900">
                    <div className="absolute inset-0">
                        <div className="absolute top-20 left-20 w-96 h-96 bg-gradient-to-r from-orange-400 to-orange-600 rounded-full blur-3xl opacity-30"></div>
                        <div className="absolute top-40 right-20 w-80 h-80 bg-gradient-to-r from-orange-500 to-orange-700 rounded-full blur-3xl opacity-30"></div>
                        <div className="absolute bottom-20 left-1/2 w-72 h-72 bg-gradient-to-r from-orange-400 to-orange-600 rounded-full blur-3xl opacity-30"></div>
                    </div>
                    ...
                    <div className="relative z-10 container mx-auto px-4 text-center">
                        <div className="max-w-4xl mx-auto">
                            ...
                            <h1 className="font-display font-bold text-4xl md:text-6xl lg:text-7xl text-white mb-6 leading-tight">
                                Apply to <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-300">
                                    Root Country School
                                </span>
                            </h1>
                        ...
                        <div className="max-w-4xl mx-auto">
                            <div className="text-center mb-12">
                                <h2 className="font-display font-bold text-3xl md:text-4xl text-slate-900 mb-6 leading-tight">
                                    Application <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700">Progress</span>
                                </h2>
      ...
      <div key={step.id} className="relative">
        <div
          className={`flex flex-col md:flex-row items-center text-center p-4 md:p-3 rounded-xl border-2 transition-all duration-300 ${
            currentStep === step.id
              ? "bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 text-white border-orange-600 shadow-lg"
              : currentStep > step.id
                            ...
                            <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-8">
                                ...
                                <div className="hidden sm:flex gap-2">
                                    {Array.from({ length: currentStep - 1 }, (_, index) => (
                                        <div key={index} className="w-2 h-2 bg-orange-200 rounded-full"></div>
                                    ))}
                                    <div className={`w-2 h-2 bg-orange-600 rounded-full transition-all duration-300 ${
                                ...
                                <Button
                                    ...
                                    disabled={!isStepValid() || isSubmitting}
                                    className="w-full sm:w-auto bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 hover:from-orange-600 hover:via-orange-700 hover:to-orange-800 text-white shadow-2xl hover:shadow-orange-500/25 px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-bold rounded-full transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    {isSubmitting ? (
                                        <>
