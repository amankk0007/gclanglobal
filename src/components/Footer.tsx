...
const Footer = () => {
  ...
  const services = [
    ...
    { label: "Engineering Colleges", href: "#" },
    { label: "Medical Colleges", href: "#" },
    { label: "Management Studies", href: "#" },
    { label: "Arts & Science", href: "#" },
    { label: "Law Colleges", href: "#" },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 mb-20">
          <div>
            ...
            <h2 className="font-display font-bold text-4xl lg:text-5xl mb-6 leading-tight">
              Start your Indian education journey <br /> with <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-white/60">confidence.</span>
            </h2>
            <p className="text-lg text-slate-400 max-w-lg mb-8">
              Join 10,000+ students receiving expert guidance for top Indian universities. No spam, just opportunities.
            </p>
          ...
          <div className="lg:pl-10 grid sm:grid-cols-2 gap-10 lg:gap-16">
            {/* Services Column */}
            <div>
              <h4 className="font-display font-bold text-lg text-white mb-6">Indian Education</h4>
