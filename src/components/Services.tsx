...
export const services: ServiceContent[] = [
  ...
  },
  {
    ...
    overviewParagraphs: [
      "Securing an offer letter from a  university is a critical milestone, but it is often fraught with complex bureaucratic hurdles and stringent documentation requirements. Our Offer Letter Assistance service ensures that this crucial phase is handled smoothly, swiftly, and without errors.",
  ...
  },
  {
    ...
    overviewParagraphs: [
      ...
      "Our industry partnerships in india span across multiple high-growth sectors including Information Technology, Telecommunications, Civil Infrastructure, Hospitality, and Pharmaceuticals. We bridge the critical gap between academic curriculum and corporate requirements, ensuring that our students are market-ready.",
        ...
        <div className="flex flex-col md:flex-row items-end justify-between gap-8 mb-12">
          <div className="max-w-2xl">
            ...
            <h2 className="font-display font-bold text-3xl md:text-5xl text-slate-900 leading-tight">
              Study in India <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">Services</span>
            </h2>
            <p className="text-slate-600 text-lg mt-3 max-w-lg">
              Complete guidance for admissions to top Indian universities. From profile building to campus placement.
            </p>
          </div>
